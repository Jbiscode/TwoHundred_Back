...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    @Query("SELECT r.id, r.content, r.createdDate, a.id, a.title, u1.username AS reviewerName, u1.offerLevel AS reviewerLevel, u2.name AS revieweeName, u2.offerLevel AS revieweeLevel " +
            "FROM Review r " +
            "JOIN r.article a " +
            "JOIN r.reviewer u1 " +
            "JOIN r.reviewee u2 " +
